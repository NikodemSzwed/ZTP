...
public class NoteCaretaker implements ICaretaker<Note>{
     ...
     * This method captures the current state of the note and saves it 
     * as a memento, which is then added to the history for future restoration.
     */
    ...
    /**
     * Restores the state of the note from a memento at the specified index 
     * in the history list. If the index is out of range, the method does nothing.
     * 
    ...
    /**
     * Restores the state of the note from the most recent memento in the history list.
     * If there are no mementos in the history, this method outputs a message indicating
     * that there is no history to restore and does nothing.
     */
    ...
    /**
     * Gets the current state of the note as a Note object.
     * This method saves the current state of the note as a memento
     * and adds it to the history before returning the note.
     * 
    ...
    /**
     * Returns a read-only version of the current state of the note. This
     * method returns a read-only version of the note, which can be used to
     * safely access the note's properties without modifying the note.
     * 
